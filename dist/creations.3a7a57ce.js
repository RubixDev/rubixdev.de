...
},{}],"ts/creations.ts":[function(require,module,exports) {
"use strict";
...
main_1.addLoadEvent(function () {
  var curseForgeButtons = document.getElementsByClassName('btn-curseforge');

  for (var buttonIndex = 0; buttonIndex < curseForgeButtons.length; buttonIndex++) {
    var button = curseForgeButtons[buttonIndex];
    var curseForgeIcon = document.createElement('i');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/creations.ts"], null)
//# sourceMappingURL=/creations.3a7a57ce.js.map